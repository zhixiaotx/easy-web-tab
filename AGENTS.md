...
npm run test:business   # Pure-function tests for businessCore.ts (22 断言 T1-T22: 归一化/种子/分类 CRUD/库存/日收入/日成本/日损耗/统计/排行/趋势坐标/进货分类过滤, node --experimental-strip-types)
