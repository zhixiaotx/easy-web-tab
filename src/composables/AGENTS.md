...
├── todoCore.ts             # 待办纯逻辑引擎: normalizeTodo(categoryId trim 后空值剔除)/TODO_PRIORITIES/BUILTIN_TODO_CATEGORIES(内置 work/life/study)/isTodoBuiltinCategory/isTodoUncategorized/filterTodos(title/description/priority/status/categoryId)/localToday/dueInfo/moveCustomCategoryInList
